...
2. **Componentele se degradează**: Vaporizatorul are o membrană care se poate uzura, injectoarele se pot înfunda, electrovanele pot începe să scape.

3. **Sistemul de aprindere afectează GPL-ul**: Dacă sistemul de aprindere al mașinii (bujii, bobine) este slab, GPL-ul nu arde corect. Problema pare a fi de la GPL, dar e de la aprindere.
...
## Intervale recomandate pentru revizia GPL
...
- **Verificare vizuală a instalației GPL**: mecanicul inspectează componentele, furtunurile, conexiunile pentru eventuale scurgeri sau deteriorări vizibile
- **Analiză computer de bord**: se citesc erorile legate de sistemul GPL (senzori, injectoare, vaporizator)
- **Verificare presiune GPL**: se verifică nivelul de presiune din rezervor și din vaporizator
- **Verificare nivel rezervor**: se verifică funcționarea senzorului de nivel

Ce se observă în această etapă:
...
Aceasta este partea principală a reviziei GPL.
...
- Funcționarea (vaporizează GPL-ul corect)
- Etanșeitatea (nu scurge)
- Senzorul de temperatură (dacă este montat în vaporizator)

Dacă vaporizatorul este uzat:
...
- Curățenia injectoarelor (nu sunt înfundate)
- Etanșeitatea (nu scurge GPL)

Dacă un injectoare este defect sau înfundat:
...
- Se reglează amestecul la sarcină redusă
- Se reglează amestecul la sarcină ridicată
- Se calibrează transferul GPL-benzină
...
- Senzor de temperatură GPL (funcționează)
- Senzor de nivel rezervor (afișează corect)
...
- Comutatorul butelie-benzină arată corect?

Dacă senzorul este defect sau dereglat:
...
- Bobine de aprindere (dacă funcționează corect)
- Filtrele de aer și gazoline (dacă sunt schimbate recent)

Dacă bujiile sunt uzate sau bobinele sunt slabe:
- Schimbare bujie: 20-80 lei per bujie
- Schimbare bobine: 100-300 lei per bobine
- Schimbare filtru aer: 30-80 lei
- Schimbare filtru benzină: 50-150 lei
...
- Se oprește motorul
- Se pornește motorul pe GPL
- Se verifică trecerea GPL-benzină și benzine-GPL
- Se testează funcționarea la sarcină redusă
...
- Completare certificat de revizie GPL

## Cât durează o revizie GPL completă

Durata reviziei GPL variază în funcție de complexitate:
...
- Prețurile sunt orientative; fiecare caz este unic
- Piesele înlocuite au costul suplimentar
- Revizia anuală completă este în general 150-250 lei pentru sistemele în stare bună

## Ce se întâmplă dacă nu faci revizia GPL

Neglijarea reviziei GPL poate duce la:

1. **Consum mare**: Filtrele înfundate reduc fluxul de GPL, computerul GPL compensează cu mai mult GPL, consum crește.

2. **Mers neregulat**: Amestecul întrerupt face ca motorul să sughite, să piardă putere sau să se oprească pe GPL.
...
6. **Risc de incendiu**: Scurgerile GPL, combinate cu temperatură ridicată, pot crea situații periculoase.

În concluzie: 150-250 lei anual poate părea mult, dar te protejează de probleme minore și majore.

## Sisteme specifice și particularitățile lor

Diferate sisteme GPL au particularități la revizie:

**Landi Renzo Omegas:**
- Filtrul de lichid este în vaporizator (se desface vaporizatorul)
- Filtrul de gaz este separat (înainte de injectoare)
- Vaporizatorul este robust (de obicei nu necesită recondiționare la revizia standard)

**Landi Renzo Omegas Direct:**
- Filtrul de lichid este în vaporizator sau în electrovană
- Filtrul de gaz este în vaporizator sau în electrovană
- Vaporizatorul este similar cu Omegas; particularități minore

**Zavoli Bora:**
- Filtrul de lichid este în vaporizator
- Filtru de gaz separat (înainte de injectoare)
- Vaporizatorul este similar cu Omegas

**Zavoli Allisei:**
- Filtrul de lichid este în electrovană (mai greu de înlocuit)
- Filtru de gaz este în vaporizator
- Vaporizatorul este similar cu Bora

**BRC Sequent:**
- Filtrul de lichid este pe supapa solidă sau în vaporizator
- Filtrul de gaz este în vaporizator sau pe rampă
- Vaporizatorul este cu debiometru integrat (verificare suplimentară necesară)

Sistemele mai vechi (STAG 200, 300, PRINS VSI) au vaporizatoare diferite, care pot necesita recondiționare mai frecvent. Sistemele mai noi (Landi Renzo Omegas Direct, Zavoli Bora) au vaporizatoare mai robuste.

## Revizia GPL și ITP-ul

ITP-ul nu verifică în mod specific instalția GPL, dar:
- Dacă GPL-ul scurge (miros vizibil), ITP-ul poate fi respins
...
## Revizia GPL și vânzarea mașinii

Dacă vinzi mașina cu GPL:
- Revizia completă realizată recent este un punct pozitiv (potential cumpărător poate verifica certificatele)
- Rezervorul GPL trebuie să fie sub 10 ani de la omologare
- Omologarea GPL trebuie să fie în carte și la zi

Dacă cumpărați o mașină cu GPL:
- Verificați data reviziei GPL (certificate)
- Verificați data expirării rezervorului GPL (mai mult de 10 ani = schimbare necesară)
- Verificați funcționarea GPL (mers pe GPL, trecere GPL-benzină)
- Verificați erorile la computer (nu trebuie să fie erori GPL)
...
Dacă ai instalat GPL-ul în ultimii 2 ani, revizia anuală este necesară pentru a menține garanția. Dacă nu faci revizia, garanția poate fi anulată (verifică contractul cu service-ul de instalare).

Dacă GPL-ul este mai vechi de 2 ani, nu mai ai garanția la instalare, dar revizia la fel este necesară pentru siguranță și funcționare.

## Rezumat: Revizia GPL în 5 puncte
...
Dacă faci revizia GPL anual, sistemul funcționează ani de zile fără probleme majore. Dacă neglijezi întreținerea, vei plăti mai târziu - și nu neapărat în bani.
